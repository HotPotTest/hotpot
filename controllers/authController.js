...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // we have to find user based on token we don't have passowrd
  ...
  user.passwordResetToken = undefined;
  user.passwordResetExpires = undefined;
  //We r using save as we want to run save middle ware function and validation not update we r using
  await user.save();
